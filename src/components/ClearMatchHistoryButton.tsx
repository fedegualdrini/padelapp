...
export default function ClearMatchHistoryButton({ slug, disabled }: Props) {
  ...
  return (
    <button
      ...
      className="rounded-full border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm font-semibold text-red-700 shadow-[0_10px_25px_rgba(239,68,68,0.15)] backdrop-blur transition hover:bg-red-500/15 disabled:cursor-not-allowed disabled:opacity-60 dark:text-red-300"
    >
