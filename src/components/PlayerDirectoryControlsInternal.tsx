...
export default function PlayerDirectoryControlsInternal({
  groupId,
  groupSlug,
}: {
  groupId: string;
  ...
  const urlStatus: StatusFilter = (["all", "usual", "invite"].includes(
    urlStatusRaw
  )
    ? urlStatusRaw
    : "all") as StatusFilter;
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Row 1: Filter buttons and Search */}
      ...
      {/* Row 2: Add Player Form - Now aligned with search row when space permits */}
