...
function SetupRequired() {
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 pb-16 pt-10 sm:px-6">
      ...
      <section className="rounded-2xl border border-[color:var(--card-border)] bg-[color:var(--card-soft)] p-6 sm:p-8 text-sm text-[var(--muted)] backdrop-blur">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1">
              ...
              para hacer <span className="font-mono font-semibold text-[var(--ink)]">vercel env pull</span>.
            </p>
          </div>
        </div>
      </section>
